...
Vi har ikke en forventning om, at elforbruget følger en bestemt funktionstype, men forventer, at forbruget kan approksimeres med et polynomium af passende grad, hvor tidspunktet på dagen er den forklarende variabel. Det er, indrømmet, nok en lidt naiv tanke, at elforbruget kan forudsiges alene ud fra én variabel, tid på dagen, der skulle nok flere variable i spil som f.eks. temperatur, nedbør, sol og vind, men vi holder os til den ene forklarende variabe7l i denne omgang.
